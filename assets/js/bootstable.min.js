...
var $tab_en_edic = null,
    params = null,
    colsEdi = null,
    newColHtml = '<div class="btn-group pull-right"> <!-- <button id="bEdit" type="button" class="btn btn-sm btn-primary" onclick="rowEdit(this);"><i class="fa fa-pencil-square-o" aria-hidden="true"> </i> </button> --> <button id="bElim" type="button" class="btn btn-sm btn-danger" onclick="rowElim(this);"><i class="fa fa-trash-o" aria-hidden="true"> </i> </button> <!-- <button id="bAcep" type="button" class="btn btn-sm btn-success" style="display:none;" onclick="rowAcep(this);"><i class="fa fa-check-square-o" aria-hidden="true"> </i> </button><button id="bCanc" type="button" class="btn btn-sm btn-danger" style="display:none;" onclick="rowCancel(this);"><i class="fa fa-times-circle" aria-hidden="true"></i> </button> --> </div>',
